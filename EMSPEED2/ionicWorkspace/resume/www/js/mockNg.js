...
//SharePoint 2007, Visual Studio 2005, Microsoft .NET Framework 3.0, C#
    ...
    var projects = [
        {
            id: 'angulardash',
            name: 'Angular.js Dashboard',
            image: 'angular.png',
            url: 'http://emspeed2.azurewebsites.net/AngularDashboard/index.html#/',
            thumb: '',
            dates: 'August 2014 - current',
            role: 'Senior HTML5 Architect',
            client: '',
            description: 'Dashboard HTML5 application completely implemented in Angular.js',
            clienttools: [
                'AngularJS 1.3',
                'Bootstrap 3',
                'ui-bootstrap',
...

        {
            ...
            name: 'Iconic Resume',
            image: 'resume.png',
            url: 'http://emspeed2.azurewebsites.net/SenchaWorkspace/Build/Production/EMSPEEDExt5/#Angular/97366',
            thumb: '',
        ...
        { 
            id: 'emspeed20', 
            name: 'HTML5 Dashboard Framework with ExtJS 5', 
            image: 'EMSPEED12.png',
            url: 'http://emspeed2.azurewebsites.net/SenchaWorkspace/Build/Production/EMSPEEDExt5/#Dashboard/97366',
            thumb: '' ,
            dates: 'May 2014 to present',
            role: 'Senior HTML5 Architect',
            client: 'Large Oil and Gas Provider - Houston, TX',
            description: 'Architected and implemented a Web-based Dashboard Framework.  Built as a 100% browser-based \'Single Page Application\' with HTML5, ExtJS5 and Angular 1.3',
            clienttools: [
        ...
        },
        {
            ...
            name: 'YouTube Viewer',
            image: 'YouTube.png',
            url: 'http://emspeed2.azurewebsites.net/SenchaWorkspace/Build/Production/extjs5youtube/#empty/empty',
            thumb: '',
            dates: 'July 2014',
            role: 'Senior HTML5 Architect',
            client: '',
        ...
        {
            id: 'ipadresume',
            name: 'Online Mobile Resume',
            image: 'me.png',
            url: 'http://emspeed2.azurewebsites.net/SenchaWorkspace/Build/Production/MjgApp/',
            thumb: '' ,
            dates: 'November 2013',
            role: 'Senior HTML5 Architect',
            client: '',
        ...
        { 
            id: 'emspeed12', 
            name: 'HTML5 Single Page Application', 
            image: 'EMSPEED12.png',
            url: 'http://emspeed2.azurewebsites.net/SenchaWorkspace/Build/Production/EMSPEEDExt5/#Dashboard/97366',
            thumb: '' ,
            dates: 'June 2012 to April 2014',
            role: 'Senior HTML5 Architect',
            client: 'Large Oil and Gas Provider - Houston, TX',
