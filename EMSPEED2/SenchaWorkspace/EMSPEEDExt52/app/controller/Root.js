            ...
            com.getData({
                ...
                callback: function (data) {
                    ...
                    for (var i = 0; i < arrayLength; i++) {
                        console.log('load... ' + s + filesArray[i]);
                        Ext.Loader.loadScript({ url: s + filesArray[i], onLoad: function () { flag += 1; }, onError: function () { console.log('FAIL'); }, scope: this });
                    }
