...
Ext.Boot = Ext.Boot || (function (emptyFn) {
    ...
    var Boot = {
        ...
        create: function (url, key) {
            console.log('Ext.Boot create ' + url);
        ...
        inject: function (content, url, asset) {
            console.log('Ext.Boot inject');
            //console.log('inject ' + url + ' ' + asset);
        ...
        load: function (request) {
            console.log('Ext.Boot load ' + request.url);
        ...
        loadUrl: function (url, request) {
            console.log('Ext.Boot loadUrl ' + url);
            //console.log('loadUrl ' + request.url);
...
Ext.Microloader = Ext.Microloader || (function () {
    var apply = function (dest, src, defaults) {
        ...
        Microloader = {
            ...
            init: function () {
                console.log('Ext.Microloader init');
            ...
            load: function (manifestDef) {
                console.log('Ext.Microloader load');
