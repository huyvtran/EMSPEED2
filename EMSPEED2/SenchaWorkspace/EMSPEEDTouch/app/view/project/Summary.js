Ext.define('EMSPEEDTouch.view.project.Summary', {
    ...
    config: {
        ...
        items: [
...

            {
                ...
                listeners: {
                    tap: function () {
                        var ref = window.open('http://emspeed1x.azurewebsites.net/sites/97366/Portal.aspx', '_blank', 'location=no');
                    }
                }
            }
        ],
    ...
    getParams: function () {
        var sParams = {
            "filter": {
                ...
                "loadPmtKpis": false,
                "loadUrls": false,
                "projectId": EMSPEEDTouch.com.getProjectId(),
                "rollUpThresholdId": 1,
