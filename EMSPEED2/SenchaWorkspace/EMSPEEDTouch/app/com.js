Ext.define('EMSPEEDTouch.com', {
    singleton: true,
    //alternateClassName: 'com',

    requires: [
    //    'EMSPEEDTouch.view.base.Header'
        'EMSPEEDTouch.view.base.MenuButton',
        'Ext.Menu',
        'Ext.Label'
    ],
    ...
    setTitle: function (me, message) {
        if (EMSPEEDTouch.com.getProjectId() != null) {
            ...
            me.down('#titleSubLabel').setHtml(EMSPEEDTouch.com.getProjectId() + '-' + EMSPEEDTouch.com.getProjectName());
        }
        else {
            me.down('#titleLabel').setHtml(me.getTitle());
            if (message != null) {
