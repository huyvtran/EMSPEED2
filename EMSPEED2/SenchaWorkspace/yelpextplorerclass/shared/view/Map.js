//alert('The google namespace ' + (((typeof google) === 'undefined') ? 'does not exist' : 'exists'));
...
Ext.define('Shared.view.Map', {
   ...
   // requiredScripts: ['http://www.google.com/jsapi'],
    ...
    //requiredScripts: ['http://maps.googleapis.com/maps/api/js?libraries=geometry&sensor=false'],
