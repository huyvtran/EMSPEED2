...
folder are mapped to the application's root namespace, 'yelpextplorerclass'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "yelpextplorerclass"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'yelpextplorerclass' in the same way
as `"yelpextplorerclass/sass/src"`.
