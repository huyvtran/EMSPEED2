...
folder are mapped to the application's root namespace, 'yelpextplorer2'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "yelpextplorer2"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'yelpextplorer2' in the same way
as `"yelpextplorer2/sass/src"`.
