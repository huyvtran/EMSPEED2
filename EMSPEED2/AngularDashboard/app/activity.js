...
angular.module('app.activity', [])
	        ...
	        link: function (scope, element, attrs, activityCtrl) {
	            ...
	            element.on('click', function (e) {
	                ...
	                if (!$this.next('.ajax-dropdown').is(':visible')) {
	                    $this.next('.ajax-dropdown').removeClass('lightSpeedOut');
	                    $this.next('.ajax-dropdown').addClass('lightSpeedIn');
	                    $this.next('.ajax-dropdown').fadeIn(150);
	                    //$this.addClass('lightSpeedIn');
	                    $this.addClass('active');
                    } else {
	                    $this.next('.ajax-dropdown').removeClass('lightSpeedIn');
	                    $this.next('.ajax-dropdown').addClass('lightSpeedOut');
	...
	.directive('activityContent', ['$compile', function ($compile) {
	    return {
	        ...
	        template: '\
				<div class="animated ajax-dropdown">\
